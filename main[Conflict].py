...
class Player(pg.sprite.Sprite):
    ...
    def __init__(self, locationX, locationY):
        ...
        self.event_log = ["Press [Z] to close this menu."]
        self.latest_event = 0
        self.num_events = 0
    ...
    def drawUI(self, ev):
        ...
        if self.uiActive and not self.tuiActive:
            ...
            # Draw HELP screen
                ...
                # Body (gameplay)
                uiText.draw(statusUI, 155, 135, "GAMEPLAY", 18, black, 255, True)
                uiText.draw(statusUI, 165, 145, "Your main goal is to survive and build up your character", 14, black, 255)
                uiText.draw(statusUI, 165, 165, "until you are strong enough to deal with the hostile A.I.", 14, black, 255)
                uiText.draw(statusUI, 165, 185, "east of the Military Compound. You can level up your skills", 14, black, 255)
                uiText.draw(statusUI, 165, 205, "simply by using them more often, and can find useful items", 14, black, 255)
                uiText.draw(statusUI, 165, 225, "in crates scattered around the wasteland. ", 14, black, 255)
    ...
    def updateMiniLog(self, ev):
        ...
        if len(self.event_log) < 1:
            uiText.draw(miniUI, 10, 17, "Press [TAB] to toggle your inventory.", 14, white, 255, True, False)
        elif len(self.event_log) >= 1:
...
# # TIMERS # #
# Define a new event in pygame for each thing to time
...
northCoastContainer = Container(670, 320, 1, "Container", contItems, True)
...
scHouseDoor = Door(595, 450, 2, "Door", None, True, 80, 10)
...
s2_cont1 = Container(525, 460, 2, "Container", contItems, True)
...
s2_cont2 = Container(525, 400, 2, "Container", contItems, True)
...
s2_cont3 = Container(385, 260, 2, "Container", contItems, True)
...
# Final wave
boss = NPC(1350, 350, 180, "Robot", "Boss", "Hostile", 1000, 200, 25, None, 250, 2)
